			...
			writeButtons = function(){
				$("#steps").addClass("steps_"+numBtn);
					...
					for(var i=0;i<numBtn;i++){
						j=i+1;
						if(numBtn==1){
							botones+='<li id="sol1Item" class="solution" style="display:none;"><span class="lbl">Solution <img src="img/ok.png" alt="solution" /></span></li><li id="next1Item" style="display:none;"><a href="#" class="next" id="next_task" title="Next Task"><span class="lbl">See Solution</span></a></li><li class="step"><a href="#" class="active" id="step_'+i+'" title="step '+i+'" onclick="accion(\'btn'+i+'\','+i+');waitStep('+i+');showSolutionAndShowNextTask();document.getElementById(\'sol1Item\').style.display=\'inline\';document.getElementById(\'next1Item\').style.display=\'inline\';return false;"><span class="lbl">See Solution</span></a></li>';
						}else{
							if(i==0) botones+='<li class="step"><a href="#" class="active" id="step_'+i+'" title="step '+i+'" onclick="accion(\'btn'+i+'\','+i+');waitStep('+i+');return false;"><span class="lbl">'+j+'</span></a></li>';
							else botones+='<li class="step"><a href="#" id="step_'+i+'" title="step '+i+'" onclick="accion(\'btn'+i+'\','+i+');waitStep('+i+');return false;"><span class="lbl">'+j+'</span></a></li>';
						}
					}
