            ...
            <div class="row well">
                <div class="col-md-6">
                    <div class="list_group">
                        ...
                        <?php } ?>
                        <?php if (isset($userPointsData->number_of_tandems)) { ?>
                            <div class="list-group-item">
                                <?php echo $LanguageInstance->get('Number of Tandems'); ?>:
                                <strong><?php echo $userPointsData->number_of_tandems; ?></strong>
                        ...
                        <?php } ?>
                        <?php if (isset($userPointsData->total_time)) { ?>
                            <div class="list-group-item">
                                <?php echo $LanguageInstance->get('Total Duration'); ?>:
                                <strong><?php echo gmdate('H:i:s', (int) $userPointsData->total_time); ?></strong>
                    ...
                    <div class="list_group">
                        ...
                        <?php if (isset($userPointsData->number_of_tandems_with_feedback)) { ?>
                            <div class="list-group-item">
                                ...
                                <strong><?php echo $userPointsData->number_of_tandems_with_feedback; ?></strong>
                            </div>
                        <?php } ?>
                        ...
                        <?php } ?>
                        <?php if (isset($userPointsData->user_feedback_stars)) { ?>
                            <div class="list-group-item">
...
<?php } ?>
    ...
    <script>
        ...
        var userHasFeedbackStars = <?php echo (!empty($userPointsData->user_feedback_stars) ? 1 : 0); ?>;
        var starsStr = "<?php echo $LanguageInstance->get('Stars'); ?>";
        var userStars = <?php echo (!empty($userPointsData) ? number_format($userPointsData->user_feedback_stars, 1) : 0); ?>;
    </script>
