...
//        error_log(serialize($partner_data));
        ...
        $body = $this->lang->getTag("Your partner is waiting for you to do a tandem, please click on the following Link to access the tandem.<br ><br /><a href='%s'>Go to Tandem</a>", $destination_url);
        $body .= static::addTandemHtmlFooter();
        $subject = $this->lang->get('Your partner is waiting for you to do a tandem');
