...
if ($send_form) {
	...
	$launch_data = array(
		...
		"custom_waiting_room" => 1,
		"custom_open_tool_id" => 1,
        "custom_enable_task_evaluation" => 1,
        "custom_show_user_status" => 1,
        "custom_disable_room_management" => 1
	);
    ...
    <div class="container">
      ...
      <div class="starter-template">
        ...
        <p class="lead">Here you will start a new Tandem.</p>
				<p class="lead"><i class="fa fa-headphones" aria-hidden="true">You will need headphones. <a href="http://videoconference.speakapps.org/videochat/testEnvironment.htm" target="_blank">Try your audio and video settings</a></i></p>
