...
class TandemCertificationPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Image($this->image_file, 8, 0, 200, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
        $this->Line(3, 50, 208, 50, $style);
    }
    ...
    public function Footer() {
        ...
        $ub_logo = 'http://mooc.speakapps.org/wp-content/uploads/2014/08/logo_home_nou-e1407657646406.png';
        $urv_logo = 'http://mooc.speakapps.org/wp-content/uploads/2014/08/logo_urv.png';
        $this->Image($uoc_logo, 10, 276, 60, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
        $this->Image($ub_logo, 75, 276, 60, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
        $this->Image($urv_logo, 140, 276, 60, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
    }
}
...
$result = $gestorBD->getRankingUserData($user_id, $course_id)  ;
...
$pdf = new TandemCertificationPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 		'UTF-8', 		 false, 			false, 'http://mooc.speakapps.org/wp-content/uploads/2014/08/logo_mooc_speakapps1.png', $LanguageInstance, $username);
...
$html .= "<span>".$LanguageInstance->get($user_position_ranking<=10 && $user_position_ranking>0?"awarded to":"This certifies that")."</span>";
$html .= "<br>";
$html .= "<br>";
...
if ($identifier && strlen($identifier)>0) {
	$html .= "<br>";
	$html .= "<br>";
	$html .= "<span class=\"tit\">".$LanguageInstance->get("ID").": ".$identifier."</span>";
}
$html .= "<br>";
$html .= "<br>";
$html .= "<span>".$LanguageInstance->get($user_position_ranking<=10 && $user_position_ranking>0?"for having successfully completed the":"has successfully completed the")."</span>";
$html .= "<br>";
$html .= "<br>";
$html .= "<span class=\"tit\">".$LanguageInstance->get("Tandem MOOC")."</span>";
$html .= "<br>";
$html .= "<br>";
$html .= "<br>";
$html .= "<span>".$LanguageInstance->get("from November 3 to December 14, 2014")."</span>";
$html .= "<br>";
...
$html .= "<br>";
$html .= $LanguageInstance->get("Director of the MOOC");
$html .= "</td>";
$html .= "<td align=\"right\">";
$html .= "<b>Barcelona, December 14, 2014</b>";
$html .= "</td>";
$html .= "</tr>";
