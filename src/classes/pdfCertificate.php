...
class TandemCertificationPDF extends TCPDF {
    ...
    public function Footer() {
        ...
        $uoc_logo = 'http://mooc.speakapps.org/wp-content/uploads/2018/03/logo_uoc.png';
        ...
        $this->Image($speakapps_logo, 106, 186, 35, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
        $this->Image($uoc_logo, 153, 190, 60, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
...
function generateCertificatePdf($user_id, $course_id, $positionRanking, $certification_data){
    ...
    $html .= "<br>";
    $html .= "<br>";
    $html .= "<span>".$LanguageInstance->get("from October 21 to December 2, 2020")."</span>";
    $html .= "<br>";
    ...
    $html .= "</td>";
    $html .= "<td align=\"right\">";
    $html .= "<b>Barcelona, December 2, 2020</b>";
    $html .= "</td>";
    $html .= "</tr>";
