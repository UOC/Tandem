...
<body>
		...
		<div id="main-container">
			...
			<div id="main" >
				...
				<div id="content">
					...
					<!-- *********************************** -->
					<h4 class="clear"><?php echo $LanguageInstance->get("You have to pass this test to access Tandem Mooc");?>.</h4>
					<!-- WAITING MODAL -->
    ...
    <div id="modal-continue" class="modal">
    	<div align="center">
	        ...
	        <div class="">
	          <a href="autoAssignTandemRoom.php" class="btn btn-success"><?php echo $LanguageInstance->get('Click here to continue');?></a>
	        </div>
	    </div>
    </div>
	<!-- /wrapper -->
...
This site reflects only the views of the authors, and the European Commission cannot be held responsible for any use which may be made of the information contained therein.</span>
	...
	<script>
		...
		$(document).ready(function() {
			...
			var flashvars = {
				rmtpServer: "rtmp://streaming.speakapps.org/videochat",
			};
			var params = {
			};
			var attributes = {
				id: "test-flash_id<?php echo time().rand()?>"
			};
			swfobject.embedSWF("js/recorder_tester.swf?version=2", "test-flash", "477", "330", "11.1.0", "expressInstall.swf", flashvars, params, attributes);
			setTranslations();
		});
