...
<p></p> 
	<div class="text">
		<p><?php echo $LanguageInstance->get('Your partner has accepted the videochat session')?>.</p>
		<p><?php echo $LanguageInstance->get('You have to enable camera to start Tandem.')?></p>
	</div>
<p></p>
</div></div></div>
