...
//hide all kind of stuff in page
			writeButtons = function(){
				$("#steps").addClass("steps_"+numBtn);
					...
					botones+='<li class="solution"><span class="lbl">Solution <img src="img/ok.png" alt="solution" /></span></li><li><a href="#" class="next" id="next_task" title="Next Task"><span class="lbl">See Solution</span></a></li>';
					$("#steps").html(botones);
