...
<head>
    ...
    <link rel="stylesheet" href="css/tandem-waiting-room.css">
                ...
                <div class="list_group">
                    <div class="list-group-item">
                        <form role='form' class="form-inline" method="post">
                            ...
                            <div class="form-group">
                                <input type='text' class="form-control" name='startDateCurrentRanking'
                            ...
                            <div class="form-group">
                                <input type='text' class="form-control" name='endDateCurrentRanking'
...
<script src="js/tandemInfo.js"></script>
<?php if (!$_SESSION[USE_WAITING_ROOM_NO_TEAMS]) { ?>
    <script>
